...
<script>
	...
	$('#new_course').click(function() {
		uni_modal("Entrada de nuevo Terreno", "manage_course.php", 'large')

	})

	$('.edit_course').click(function() {
		uni_modal("Administrar la entrada de Terreno", "manage_course.php?id=" + $(this).attr('data-id'), 'large')

	})
	$('.delete_course').click(function() {
		_conf("¿Deseas eliminar este Terreno?", "delete_course", [$(this).attr('data-id')])
	})
