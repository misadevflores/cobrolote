...
<div class="container-fluid">
	<p class="text-center"><b><?php echo $_GET['pid'] == 0 ? "Factura" : 'Recibo de Pago' ?></b></p>
	<hr>
	<div class="flex">
		<div class="w-50">
			<p>No de Curso: <b><?php echo $ef_no ?></b></p>
			<p>Estudiante: <b><?php echo ucwords($sname) ?></b></p>
			<p>Terreno: <b><?php echo $class ?></b></p>
		</div>
		<?php if ($_GET['pid'] > 0) : ?>
			<div class="w-50">
				<p>Fecha de Pago: <b><?php echo isset($pay_arr[$_GET['pid']]) ? date("M d,Y", strtotime($pay_arr[$_GET['pid']]['payment_date'])) : '' ?></b></p>
